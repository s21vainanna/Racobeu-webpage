...
@NoArgsConstructor
@ToString
public class Scientific_Research {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int scientific_research_id;
	...
	public Scientific_Research(String name, String description, RadioAstronomy_Institutions radioAstronomy_Institutions) {
		this.name = name;
